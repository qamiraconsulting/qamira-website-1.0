...
//
// IMPORTANT: Qamira has no publicly citable client engagements yet. Rather
// than leave this page empty or fabricate client claims, these are
// illustrative composite scenarios -- clearly labeled as such in the UI --
// written in plain, non-technical language around the five problem areas we
// most often get called in for. Replace with real, citable engagements as
// they become available; see caseStudiesHero.disclaimer, which must stay
// attached to this content however it's displayed.

export const caseStudiesHero = {
  eyebrow: "Illustrative, not testimonial",
  title: "The kinds of problems we get called in for.",
  lede: "We're a young firm -- these are illustrative, composite scenarios written to show the kind of problem we solve and how we think about it, not claims about specific clients. We'll publish real engagement results here as they become citable.",
  disclaimer:
